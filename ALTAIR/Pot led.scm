...
<model name="Pot led">
  ...
  <edition>
    <properties>
      ...
      <property name="creationdate" value="01/09/20 10:39:52"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="04/19/24 13:58:08"/>
      <property name="comments" value="Twin Activate &quot;Arduino&quot; Library demo model"/>
    </properties>
  </edition>
  <initialization/>
  <finalization/>
  <diagram>
    <block name="SampleClock" type="block">
      ...
      <graphics>
        ...
        <position x="-152.85435485839844" y="-236.188720703125"/>
    ...
    <block name="ActivationSplit" type="activation_split">
      ...
      <graphics>
        ...
        <background color="183,15,19,255"/>
        <position x="-132.85435485839844" y="-175.2737274169922"/>
    ...
    <block name="Circuit View" type="block">
      <diagram>
        <block name="SuperBlock" type="block">
          ...
          <graphics>
            ...
            <background color="255,255,255,0"/>
            <position x="-239.0670166015625" y="-486.7198791503906"/>
            <size width="780" height="636"/>
            <rotate angle="0"/>
            <texts>
              <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
            </texts>
            <images>
              <image name="image1" file="circuit_potled.svg" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
            </images>
            <flip value="0">
              <images>
                <image name="image2" file="circuit_potled.svg" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
              </images>
            </flip>
          </graphics>
          <ports/>
        ...
        <block name="Circuit" type="block">
          ...
          <graphics>
            ...
            <frame shape="rectangle" visible="0" color="0,0,0,255" thickness="1.5"/>
            <background color="255,255,255,0"/>
            <position x="685.2009811401367" y="-426.7198791503906"/>
            <size width="408" height="516"/>
            <rotate angle="0"/>
            <texts>
              <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
            </texts>
            <images>
              <image name="image1" file="Pot_led.jpg" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
            </images>
            <flip value="0">
              <images>
                <image name="image2" file="Pot_led.jpg" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
              </images>
            </flip>
          </graphics>
          <ports/>
      ...
      <graphics>
        ...
        <background color="238,226,235,254"/>
        <position x="93.60353851318359" y="-155.1801528930664"/>
    ...
    <block name="ArduinoConfiguration_1" type="block">
      ...
      <graphics>
        ...
        <position x="-62.225990295410156" y="-245.63153076171875"/>
      ...
      <parameters>
        <section name="Serial">
          <parameter name="com_port" value="&apos;COM4&apos;"/>
          <parameter name="baudrate" value="115200"/>
        </section>
      </parameters>
    </block>
    <block name="led_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="0,151,157,255"/>
        <position x="-52.225990295410156" y="-148.188720703125"/>
    ...
    <block name="Potentiometer_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="0,151,157,255"/>
        <position x="-172.85435485839844" y="-148.188720703125"/>
    ...
    <block name="Scope" type="block">
      ...
      <graphics>
        ...
        <position x="232.30389404296875" y="-300.1777648925781"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Split" type="regular_split">
      ...
      <graphics>
        ...
        <background color="64,64,64,255"/>
        <position x="-76.96466827392578" y="-108.188720703125"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Display" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="188.09637451171875" y="-378.3911437988281"/>
        <size width="96" height="48"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.500000" y="0.500000" rotate="1" visible="1" font="Arial,10" align="center">   0.402737</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
    ...
    <block name="Block" type="regular_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="64,64,64,255"/>
        <position x="139.70428466796875" y="-280.1777648925781"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Potentiometer_1" port="1" iotype="out"/>
    ...
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="led_1" port="1" iotype="in"/>
      <to block="ActivationSplit" port="2" iotype="out"/>
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="-22.225990295410217" y="-175.27372741699224"/>
      </points>
    </link>
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ActivationSplit" port="1" iotype="out"/>
      <to block="Potentiometer_1" port="1" iotype="in"/>
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="explicit">
    ...
    <link name="" type="Explicit">
      ...
      <to block="led_1" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="139.70428466796875" y="-354.3911437988281"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-76.96466827392578" y="-280.1777648925781"/>
      </points>
    </link>
    <annotation name="Annotation" type="text">
      <frame shape="rectangle" visible="0" color="0,0,0,255" cornerradius="0" thickness="1.5"/>
      <background color="0,0,0,0"/>
      <position x="-170.48660278320312" y="-46.302650451660156"/>
      <size width="466" height="28"/>
      <rotate angle="0"/>
      <text font="Arial,10" color="0,0,0,255">This model change the intensity of the led by changing the value of the potentiometer. </text>
    </annotation>
    <context/>
    <graphics>
      <viewport width="800" height="800" topleftx="0" toplefty="0"/>
